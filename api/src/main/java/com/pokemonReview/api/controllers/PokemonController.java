...
public class PokemonController {
    ...
    @Operation(
            ...
            description = "Fetch all pokemons present in the DB"
    ...
    @Operation(
            summary = "Fetch all pokemons",
            description = "Fetch all pokemons present in the DB, And return the result in pagination protocol defined at parameters"
    ) // Swagger - To give header for individual API
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Pokemons fetched successfully!"),
            @ApiResponse(responseCode = "404", description = "No pokemon present in the DB"),
    }) // Swagger - To give better message for each response from the API
    ...
    @Operation(
            summary = "Fetch a single pokemon",
            description = "Fetch the pokemon from the DB using ID given in the URL"
    ) // Swagger - To give header for individual API
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Pokemon fetched successfully!"),
            @ApiResponse(responseCode = "404", description = "Pokemon not found, Try with different ID"),
    }) // Swagger - To give better message for each response from the API
    ...
    @Operation(
            ...
            description = "Save a single pokemon in the DB"
    ) // Swagger - To give header for individual API
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Pokemon saved successfully!"),
            @ApiResponse(responseCode = "404", description = "Pokemon was not saved. Check JSON."),
    }) // Swagger - To give better message for each response from the API
    @PostMapping("pokemon")
    ...
    @Operation(
            ...
            description = "Update a single pokemon with ID given at URL path"
    ) // Swagger - To give header for individual API
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Pokemon updated successfully!"),
            @ApiResponse(responseCode = "404", description = "Pokemon update failed"),
    }) // Swagger - To give better message for each response from the API
    ...
    @Operation(
            ...
            description = "Remove a single pokemon from DB with ID given at URL path"
    ) // Swagger - To give header for individual API
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "pokemon deleted successfully!"),
            @ApiResponse(responseCode = "404", description = "Pokemon was not deleted from DB"),
    }) // Swagger - To give better message for each response from the API
